...
SDL_PROC(void,glColorTable,(GLenum target, GLenum internalformat, GLint width, GLenum format, GLenum type, GLvoid *data))
...
SDL_PROC(void,gluPerspective,(GLdouble fovy, GLdouble aspect, GLdouble zNear, GLdouble zFar))
SDL_PROC(void,gluLookAt,(GLdouble eyex, GLdouble eyey, GLdouble eyez, GLdouble centerx, GLdouble centery, GLdouble centerz, GLdouble upx, GLdouble upy, GLdouble upz ))
